...
###### READ ME ######
# This script is a boilerplate pre-causal EDA template to determine if the data passes the parallel trends
# assumption as well as a basic pre/post difference check.
